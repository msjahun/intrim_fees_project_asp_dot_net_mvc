...
namespace Intrim_fees_project.Controllers
{
    ...
    //    public IHttpActionResult OnPostSend()
    //    {
    ...
    //                            faci.Add(new Facility { facility_name = "Room Area: " + room_t.room_area + " m" + "<sup style=\"font-size: smaller; \">2</sup>", facility_icon_url = "./Dormitories_files/kitchen.png" });
    //                            faci.Add(new Facility { facility_name = "Price: " + dorm.room_price_currency + " " + room_t.room_price, facility_icon_url = "./Dormitories_files/thumbnail(3).png" });
